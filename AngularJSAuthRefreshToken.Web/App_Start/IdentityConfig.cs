...
using ClaimsIdentityFactory = AngularJSAuthRefreshToken.Web.AspNetIdentity.ClaimsIdentityFactory<AngularJSAuthRefreshToken.Web.AspNetIdentity.IdentityUser,string>;
...
namespace AngularJSAuthRefreshToken.Web.Models
{
    ...
    {
        IUserStore<TUser, TKey> Store { get; }
    }
    ...
    public class ApplicationUserManager : UserManager<IdentityUser>, IPublicUserStore<IdentityUser, string>
    {
        ...
        IUserStore<IdentityUser, string> IPublicUserStore<IdentityUser, string>.Store
        {
            get
            {
                return this.Store;
    ...
    public class ApplicationRefreshTokenManager : IRefreshTokenStore
    {
        ...
        public Task<RefreshTokenClient> FindClientByIdAsync(string id)
        {
            return this.store.FindClientByIdAsync(id);
        }

        public Task<bool> ContainsClientByIdAsync(string id)
        {
            return this.store.ContainsClientByIdAsync(id);
        }
        ...
        public Task<bool> IsValidSecret(RefreshTokenClient client, string client_secret)
        {
            bool result = false;
