...
(function (angular) {
    ...
    angular.module('ea.services')
        .factory('ea.authorization', ['$state', 'ea.authentication', function ($state, authentication) {
            ...
            return {
                ...
                isMyEmail: function (email) {
                    return authentication.email().toLowerCase() === email.toLowerCase();
                },
